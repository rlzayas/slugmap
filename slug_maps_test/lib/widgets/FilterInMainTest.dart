...
class FilterInMainTest extends StatefulWidget {
  @override
  _FilterInMainTestState createState() => _FilterInMainTestState();
}

class _FilterInMainTestState extends State<FilterInMainTest> {
