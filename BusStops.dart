...
class BusStops extends StatefulWidget {
  ...
  BusStops(this.latitude, this.longitude);
...
class _BusStopsState extends State<BusStops> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // floatingActionButton:
      //     buildSpeedDial(context, phoneWidth, phoneHeight, _visible),
    ); //812 x 375
  }
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: _boxes(
                  ...
                  36.99287781889026,
                  -122.06492693162627,
                  "Heller Dr - Rachel Carson & Porter",
                  ''),
            ),
            SizedBox(width: 10.0),
            Padding(
  ...
  Widget _boxes(
      String _image, double lat, double long, String title, String snippet) {
    return GestureDetector(
      onTap: () {
        var searchPgCoord =
            new BusStops(this.widget.latitude, this.widget.longitude);
        _gotoLocation(searchPgCoord.latitude, searchPgCoord.longitude);
        print(searchPgCoord.latitude);
        print(searchPgCoord.longitude);
      },
      child: Container(
        child: new FittedBox(
          child: Material(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: myDetailsContainer1(title, snippet),
                    ),
                  )
                ],
              )),
